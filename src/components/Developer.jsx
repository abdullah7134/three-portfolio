...
const Developer = ({ animationName = 'idle', ...props }) => {
    ...
    const { nodes, materials } = useGLTF('/models/huh.glb')
    ...
    return (
        <group ref={groupRef} {...props} dispose={null}>
            {/* FIX: rotate just the skeleton rig to face forward */}
            <group rotation={[0, Math.PI, 0]}>
                <primitive object={nodes.Hips} />
            </group>

            {/* Skinned meshes (stay outside so they're still bound correctly) */}
            <skinnedMesh
                name="EyeLeft"
...
useGLTF.preload('/models/huh.glb')
